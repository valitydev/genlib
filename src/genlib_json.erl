...
-spec new() -> Object when Object :: object().
new() ->
    {[]}.
...
-spec size(Object) -> non_neg_integer() when Object :: object().
size(Object) ->
...
-spec to_map(Object) -> map() | scalar() when Object :: object().
to_map(Object) ->
    to_map_opt(Object).
...
-spec from_map(map() | scalar()) -> Object when Object :: object().
from_map(Map) ->
    from_map_opt(Map).
